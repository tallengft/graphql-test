 ...
 */
exports.isValidISOString = isoString => !isNaN(Date.parse(isoString));
 ...
 */
exports.getCurrentISOStringDate = () => moment().toISOString();
 ...
 */
exports.getISOStringFromDate = (date) => {
 ...
 */
exports.getDateFromISOString = (isoString) => {
